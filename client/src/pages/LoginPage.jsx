    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-gray-900">
      <div className="w-full max-w-sm rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="mb-1 flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-xs text-indigo-700 hover:underline dark:text-indigo-400">
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <p className="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <Link to="/signup" className="font-medium text-indigo-700 hover:underline dark:text-indigo-400">
            Sign up
          </Link>
        </p>
      </div>
